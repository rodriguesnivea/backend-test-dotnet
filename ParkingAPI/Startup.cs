...
namespace ParkingAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var issuerString = Configuration["JwtBearerTokenSettings:Issuer"];
            var audienceString = Configuration["JwtBearerTokenSettings:Audience"];
            var secretKeyString = Configuration["JwtBearerTokenSettings:SecretKey"];
